...
class Movie(TimeStampedModel):
    ...
    rating = models.FloatField(_('рейтинг'), validators=[MinValueValidator(0), MaxValueValidator(100)], **NULL_BLANK)
    certificate = models.CharField(_('сертификат'), max_length=20, choices=CertificateType.choices,
                                   default=CertificateType.empty, **NULL_BLANK_FALSE)
    file_path = models.FileField(_('файл'), upload_to='movies/', **NULL_BLANK)
    type = models.CharField(_('тип'), max_length=20, choices=MovieType.choices, default=MovieType.movie,
                            **NULL_BLANK_FALSE)
...
class MoviePerson(TimeStampedModel):
    ...
    person = models.ForeignKey(Person,
                               ...
                               on_delete=models.RESTRICT,
                               **NULL_BLANK)
    role = models.CharField(_('роль'), max_length=20, choices=RoleType.choices, **NULL_BLANK_FALSE)
